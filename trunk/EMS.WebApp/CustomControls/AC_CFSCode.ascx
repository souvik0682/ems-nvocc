<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AC_CFSCode.ascx.cs" Inherits="EMS.WebApp.CustomControls.AC_CFSCode" %>
...
<div>
    <asp:TextBox runat="server" ID="txtCFSCode" autocomplete="off" ForeColor="#747862"

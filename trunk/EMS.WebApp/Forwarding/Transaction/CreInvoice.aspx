            ...
            <table border="0" cellpadding="2" cellspacing="3" width="100%" >
               <style>
                ...
                <tr>
                    ...
                    <td class="style1">Party Type:<span class="errormessage1">*</span></td>
                    
                    <td class="style2"><asp:DropDownList ID="ddlPartyType" runat="server"  CssClass="dropdownlist" AutoPostBack="true"
                    ...
                    <td class="style3"><asp:DropDownList ID="ddlCreditorName" runat="server"  CssClass="dropdownlist" >
                      <asp:ListItem Text="--Select--" Value="0"></asp:ListItem>
                      </asp:DropDownList>
                      <br />
                ...
                <tr>
                    <td class="style1" >Invoice No<span class="errormessage1">*</span></td>
                    <td class="style2">
                     <asp:TextBox ID="txtCreInvoiceNo" runat="server" CssClass="textboxuppercase" MaxLength="60" Width="250"></asp:TextBox><br />
                        <asp:RequiredFieldValidator ID="rfvtxtAdjustmentDate" runat="server" CssClass="errormessage" 
                            ControlToValidate="txtCreInvoiceNo" Display="Dynamic" ErrorMessage="[Required]" ValidationGroup="Save"></asp:RequiredFieldValidator>    
                    </td>
                ...
                <tr>
                    <td class="style1">Reference No:</td>
                    <td class="style2">  <asp:Label ID="lblOurInvoiceRef" runat="server" Text="AutoGenerated"></asp:Label>  
                    </td>
               
                    <td>Reference Date:<span class="errormessage1">*</span></td>
                    <td class="style3"> <asp:TextBox ID="txtReferenceDate" runat="server" CssClass="textboxuppercase" MaxLength="60" Width="250"></asp:TextBox><br />
                ...
                <tr>
                    <td class="style1">Job Number:</td>
                    <td class="style2"><asp:Label ID="lblJobNumber" runat="server" Text="Label"></asp:Label>
                    </td>
                    <td>
                        Job Date
                    </td>
                ...
                <tr>
                    ...
                    <td class="style2"> <asp:Label ID="lblLocation" runat="server" Text=""></asp:Label>      
                   </td>
                ...
                <tr>
                    ...
                    <td class="style3">
                        ...
                        <asp:RequiredFieldValidator ID="rfvComment" runat="server" CssClass="errormessage" 
                            ControlToValidate="txtComment" Display="Dynamic" ErrorMessage="[Required]" ValidationGroup="Save"></asp:RequiredFieldValidator>  
                    </td>
                </tr>
                <tr>   
                <td colspan="4">    

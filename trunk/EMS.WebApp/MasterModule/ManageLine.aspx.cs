...
{
    public partial class ManageLine : System.Web.UI.Page
    {
        ...
        protected void gvwLoc_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Cells[1].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "pk_NVOCCID"));
                ...
                btnEdit.CommandArgument = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "pk_NVOCCID"));

                //Delete link
                ImageButton btnRemove = (ImageButton)e.Row.FindControl("btnRemove");
                btnRemove.ToolTip = ResourceManager.GetStringWithoutName("ERR00012");
                btnRemove.CommandArgument = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "pk_NVOCCID"));
        ...
        private void DeletLine(int pk_NVOCCId)
        {
        ...
        private void RedirecToAddEditPage(int id)
        {
            ...
            Response.Redirect("~/MasterModule/AddEditLine.aspx?id=" + encryptedId);
        }
        ...
        private void BuildSearchCriteria(SearchCriteria criteria)
        {
            ...
            criteria.LocAbbr = (txtLine.Text == ResourceManager.GetStringWithoutName("ERR00030")) ? string.Empty : txtLine.Text.Trim();

...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function AutoCompleteItemSelected(sender, e) {
            if (sender._id == 'container_AutoCompletepPort1_AutoPort') {
                var hdnBLId = $get('<%=hdnPortId.ClientID %>');
                hdnBLId.value = e.get_value();
                document.getElementById('<%= btnFillEdi.ClientID %>').click();
            }
                ...
                <tr>
                    <td style="width: 50%; vertical-align: top;">
                        <table width="100%">
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlVessel" runat="server" Width="67%" AutoPostBack="True" OnSelectedIndexChanged="ddlVessel_SelectedIndexChanged">
                                    </asp:DropDownList>
                                    <br />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="errormessage"
                                        ControlToValidate="ddlVessel" Display="Dynamic" InitialValue="0" Text="This field is Required"
                                ...
                                <td>
                                    ...
                                    <asp:Panel ID="pnlLine" runat="server" Style="display: none;">
                                        <div style="height: 280; width: 300px; overflow: auto;background-color:White;">
                                            ...
                                            <div id="dvMoneyReceived" runat="server" style="width: 100%; height: 240px; overflow: auto;
                                                background-color: White; padding-top: 15px; text-align: center;">
                                                <table style='width: 100%; border: none;' cellpadding='2' cellspacing='0'>
                                                    <tr style='background-color: #328DC4; color: White; font-weight: bold;'>
                                                    ...
                                                    <asp:Repeater ID="rpEDI" runat="server">
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <asp:HiddenField ID="hdnLineId" runat="server" Value='<%# Eval("ID") %>' />
                                                                <%# Eval("NVOCCNAME")%>
                                                                </td>
                                                                <td><%# Eval("TOTALBL")%>
                                                                </td>
                                                        ...
                                                        <AlternatingItemTemplate>
                                                            <tr style='background-color: #99CCFF;text-align:left;'>
                                                             <td>
                                                                <td>
                                                                <asp:HiddenField ID="hdnLineId" runat="server" Value='<%# Eval("ID") %>' />
                                                                <%# Eval("NVOCCNAME")%>
                                            ...
                                            <div style="width:100%; text-align:center;height:30px;"><asp:Button ID="btnSave" runat="server" Text="Save" OnClick="SaveEDI" /></div>
                                        </div>
                                    </asp:Panel>
                                    <!-- -->
                                    <br />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" CssClass="errormessage"
                                        InitialValue="0" ControlToValidate="ddlVoyage" Display="Dynamic" Text="This field is Required"
                                        ValidationGroup="Save"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtCallSign" runat="server" ReadOnly="true" CssClass="textboxuppercaseRO"
                                        MaxLength="60" Width="250"></asp:TextBox><br />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlMsgType" runat="server" Width="67%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtIGMNo" runat="server" CssClass="textboxuppercaseRO" ReadOnly="true"
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <cc2:CalendarExtender ID="dtIGM_" Format="dd/MM/yyyy" TargetControlID="txtDtIGM"
                                        runat="server" />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtShipCode" runat="server" CssClass="textboxuppercaseRO" ReadOnly="true"
                                        MaxLength="15" Width="250"></asp:TextBox><br />
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 140px;">
                                ...
                                <td>
                                    <asp:TextBox ID="txtPAN" runat="server" CssClass="textboxuppercaseRO" ReadOnly="true"
                                        MaxLength="13" Width="250"></asp:TextBox><br />
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 140px;">
                                ...
                                <td>
                                    <asp:TextBox ID="txtMaster" runat="server" CssClass="textboxuppercaseRO" ReadOnly="true"
                                        MaxLength="20" Width="250"></asp:TextBox><br />
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 140px;">
                                ...
                                <td>
                                    <asp:TextBox ID="txtVesselFlag" runat="server" CssClass="textboxuppercaseRO" ReadOnly="true"
                                        MaxLength="20" Width="250"></asp:TextBox><br />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="width: 230px">
                                        ...
                                        <asp:DropDownList ID="ddlCustomHouse" Width="80%" runat="server">
                                        </asp:DropDownList>
                                    </div>
                                </td>
                            </tr>
                    ...
                    <td style="width: 50%; vertical-align: top;">
                        <table width="100%">
                            <tr>
                                <td style="width: 140px;">
                                    Port of Discharge:<span class="errormessage1">*</span>
                                </td>
                                <td>
                                    <div style="width: 230px">
                                        <uc2:AutoCompletepPort ID="AutoCompletepPort1" runat="server" />
                                        <asp:Button ID="btnFillEdi" runat="server" Style="display: none;" OnClick="btnFillEdi_Click" />
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtIMONo" runat="server" CssClass="textboxuppercase" MaxLength="5"
                            ...
                            <tr>
                                <td style="width: 140px;">
                                    Total Lines: <span class="errormessage1">*</span>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtTotLine" runat="server" CssClass="textboxuppercase" MaxLength="15"
                                        Width="250"></asp:TextBox><br />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" CssClass="errormessage"
                                        ControlToValidate="txtTotLine" Display="Dynamic" Text="This field is Required"
                                        ValidationGroup="Save"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtCargoDesc" runat="server" CssClass="" MaxLength="500" Width="250"></asp:TextBox><br />
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 140px;">
                                ...
                                <td>
                                    ...
                                    <cc2:CalendarExtender ID="dtArrival_" TargetControlID="txtdtArrival" Format="dd/MM/yyyy"
                                        runat="server" />
                                    Time
                                    <asp:TextBox ID="txtArriveTime" runat="server" Width="100"></asp:TextBox>
                                    <cc2:TextBoxWatermarkExtender ID="txtWMEAbbr" runat="server" TargetControlID="txtArriveTime"
                                        WatermarkText="hh:mm">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <cc1:CustomTextBox ID="txtLightHouse" runat="server" CssClass="numerictextbox" Type="Decimal"
                                        MaxLength="13" Precision="10" Scale="2" Width="100"></cc1:CustomTextBox>
                                    <br />
                                </td>
                            </tr>
                            <tr>
                    ...
                    <td colspan="2" style="text-align: center">
                        <center>
                            <asp:Button ID="btnDownLoad" runat="server" CssClass="button" OnClick="btnDownLoad_Click"
                                ValidationGroup="Save" Text="Download" />
                        </center>
                    </td>
                </tr>
            </table>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="import-haulage-chrg-add-edit.aspx.cs" Inherits="EMS.WebApp.import_haulage_chrg_add_edit" %>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="rfvFLocation" runat="server" ErrorMessage="Please select location"
                                Display="None" ControlToValidate="ddlFromLocation" ValidationGroup="vgHaulage" InitialValue="0"></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="rfvTLocation" runat="server" ErrorMessage="Please select location"
                                Display="None" ControlToValidate="ddlToLocation" ValidationGroup="vgHaulage" InitialValue="0"></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="rfvContainerSize" runat="server" ErrorMessage="Please select container size"
                                Display="None" ControlToValidate="ddlContainerSize" ValidationGroup="vgHaulage" InitialValue="0"></asp:RequiredFieldValidator>

...
{
    public partial class JobBL : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/Forwarding/Transaction/ManageJobBL.aspx");
        }
        ...
        protected void gvExportBL_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName == "Dashboard")
            {
                ...
                Response.Redirect("~/Forwarding/Transaction/Dashboard.aspx?BLNumber=" + encryptedId);
            }
            else if (e.CommandName == "RemoveData")
            {
                ...
                //Active/InActive
                JobBLBLL.ChangeBLStatus(Convert.ToString(e.CommandArgument), IsActive);
            ...
            if (!ReferenceEquals(Session[Constants.SESSION_USER_INFO], null))
            {
                ...
                if (!ReferenceEquals(Session[Constants.SESSION_SEARCH_CRITERIA], null))
                {
                    ...
                    if (!ReferenceEquals(searchCriteria, null))
                    {
                        ...
                        gvExportBL.DataSource = JobBLBLL.GetExportBLForListing(searchCriteria);
                        gvExportBL.DataBind();
                    }
                }
            }
        ...
        private void RedirecToAddEditPage(string blNumber)
        {
            ...
            Response.Redirect("~/Forwarding/Transaction/ManageJobBL.aspx?BLNumber=" + encryptedId);
        }

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageFLoc.aspx.cs" Inherits="EMS.WebApp.Forwarding.Master.ManageFLoc" MasterPageFile="~/Site.Master" Title=":: Forwarding :: Manage Location" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="container" runat="Server">
    ...
    <div id="headercaption">MANAGE FORWARDING LOCATION</div>
    <center>
        ...
        <fieldset id="fsList" runat="server" style="width:100%;min-height:100px;">
            ...
            <div style="float:right;padding-bottom:5px;">
                Results Per Page:<asp:DropDownList ID="ddlPaging" runat="server" Width="50px" AutoPostBack="true" 
                    ...
                    <asp:Button ID="btnAdd" runat="server" Text="Add Location" Width="150px"

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="AdvanceContainerList.aspx.cs" Inherits="EMS.WebApp.Reports.AdvanceContainerList" %>
        ...
        <fieldset style="padding: 5px; width: 55%">
            <table style="width: 100%" cellpadding="1" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        VIA No:<span class="errormessage">*</span>
                    </td>
                    <td align="left">
                        <asp:TextBox ID="txtVIANo" runat="server" Width="145"></asp:TextBox>

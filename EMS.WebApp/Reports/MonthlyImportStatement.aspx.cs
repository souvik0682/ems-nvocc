...
{
    public partial class MonthlyImportStatement : System.Web.UI.Page
    {
        ...
        private void GenerateReport()
        {
            ...
            try
            {
                ...
                dtExcel = cls.GetMonthlyImportStatement(dt1, dt2, ddlLine.SelectedValue, ddlLoc.SelectedValue);
        ...
        private void ExporttoExcel(DataTable table)
        {
            ...
            HttpContext.Current.Response.AddHeader("Content-Disposition", "attachment;filename=MonthlyImportStatement.xls");

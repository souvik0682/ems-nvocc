<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ImportRegister.aspx.cs" Inherits="EMS.WebApp.Reports.ImportRegister" Title=":: Liner :: Import Register" %>
                ...
                <tr>
                    ...
                    <td style="padding-right:20px;vertical-align:top;">
                        <asp:TextBox runat="server" ID="txtVessel" MaxLength="100" Width="200" 
                            autocomplete="off" ontextchanged="txtVessel_TextChanged" AutoPostBack="True" />

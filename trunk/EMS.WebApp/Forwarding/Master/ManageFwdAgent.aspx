<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageFwdAgent.aspx.cs" MasterPageFile="~/Site.Master" Inherits="EMS.WebApp.Forwarding.Master.ManageFwdAgent" %>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lnkHLine" runat="server" CommandName="Sort" CommandArgument="NVOCC"
                                                Text="Principal"></asp:LinkButton></HeaderTemplate>
                                        <ItemTemplate>

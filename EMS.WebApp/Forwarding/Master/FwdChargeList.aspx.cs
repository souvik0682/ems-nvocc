...
{
    public partial class FwdChargeList : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/Forwarding/Master/FwdChargeAddEdit.aspx");
        }
        ...
        private void LoadCharge()
        {
            if (!ReferenceEquals(Session[Constants.SESSION_SEARCH_CRITERIA], null))
            {
                ...
                if (!ReferenceEquals(searchCriteria, null))
                {
                    ...
                    gvwCharge.DataSource = ChargeBLL.GetAllCharges(searchCriteria, 1, 'F');
                    gvwCharge.DataBind();
                }
            }
        }
        ...
        private void RedirecToAddEditPage(int id)
        {
            ...
            Response.Redirect("~/Forwarding/Master/FwdChargeAddEdit.aspx?id=" + encryptedId);
        }

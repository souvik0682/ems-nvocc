...
{
    public partial class ManageFLine : System.Web.UI.Page
    {
        ...
        protected void gvwLine_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            int newIndex = e.NewPageIndex;
            gvwLine.PageIndex = e.NewPageIndex;
            SaveNewPageIndex(e.NewPageIndex);
            LoadFLine();
        }

        protected void gvwLine_RowCommand(object sender, GridViewCommandEventArgs e)
        {
        ...
        protected void gvwLine_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                btnEdit.CommandArgument = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "LineID"));

                //Delete link
                ImageButton btnRemove = (ImageButton)e.Row.FindControl("btnRemove");
                btnRemove.ToolTip = ResourceManager.GetStringWithoutName("ERR00012");
                btnRemove.CommandArgument = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "LineID"));
        ...
        {
            Response.Redirect("~/Forwarding/Master/AddEditFLine.aspx");
        }
        ...
        {
            gvwLine.PagerSettings.PageButtonCount = Convert.ToInt32(ConfigurationManager.AppSettings["PageButtonCount"]);
        }
        ...
        private void LoadFLine()
        {
            if (!ReferenceEquals(Session[Constants.SESSION_SEARCH_CRITERIA], null))
            {
                ...
                if (!ReferenceEquals(searchCriteria, null))
                {
                    ...
                    fwLineBLL commonBll = new fwLineBLL();

                    gvwLine.PageIndex = searchCriteria.PageIndex;
                    if (searchCriteria.PageSize > 0) gvwLine.PageSize = searchCriteria.PageSize;

                    gvwLine.DataSource = fwLineBLL.GetfwLine(searchCriteria);
                    gvwLine.DataBind();
                }
            }
        }
        ...
        {
            fwLineBLL.DeletFwLine(FLineID, _userId);
            LoadFLine();
        ...
        private void RedirecToAddEditPage(int id)
        {
            ...
            Response.Redirect("~/Forwarding/Master/AddEditFLine.aspx?id=" + encryptedId);
        }
            ...
            if (!ReferenceEquals(Session[Constants.SESSION_SEARCH_CRITERIA], null))
            {
                ...
                if (!ReferenceEquals(criteria, null))
                {
                    ...
                    else
                    {
                        ...
                        gvwLine.PageIndex = criteria.PageIndex;
                        gvwLine.PageSize = criteria.PageSize;

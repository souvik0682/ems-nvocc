        ...
        <fieldset style="width:95%;">
            ...
            <table border="0" cellpadding="1" cellspacing="0" width="100%" class="custtable">
                ...
                <tr>
                    ...
                    <td></td>
                    <td>Phone2:</td>
                    <td><asp:TextBox ID="txtPhone2" runat="server" CssClass="textboxuppercase" MaxLength="50" Width="250" TabIndex="12"></asp:TextBox><br /><asp:RegularExpressionValidator ID="revPhone2" runat="server" ControlToValidate="txtPhone2" CssClass="errormessage" ValidationGroup="Save" Display="Dynamic"></asp:RegularExpressionValidator></td>
                </tr>
                <tr>
                    <td>Pin:</td>
                    <td><asp:TextBox ID="txtPin" runat="server" CssClass="textboxuppercase" MaxLength="10" Width="150" TabIndex="3"></asp:TextBox>&nbsp;&nbsp;<asp:Button ID="btnSearch" runat="server" TabIndex="4" Text="Search Area" Height="24" OnClick="btnSearch_Click" /></td>
                    <td></td>
                ...
                <tr>
                    ...
                    <td></td>
                    <td>PAN:</td>
                    <td><asp:TextBox ID="txtPan" runat="server" CssClass="textboxuppercase" MaxLength="10" Width="250" TabIndex="14"></asp:TextBox></td>
                </tr>
                <tr>
                    ...
                    <td></td>
                    <td>TAN:</td>
                    <td><asp:TextBox ID="txtTan" runat="server" CssClass="textboxuppercase" MaxLength="15" Width="250" TabIndex="15"></asp:TextBox></td>
                </tr>
                <tr>
                    ...
                    <td></td>
                    <td>BIN:</td>
                    <td><asp:TextBox ID="txtBin" runat="server" CssClass="textboxuppercase" MaxLength="15" Width="250" TabIndex="16"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>Customer Name:<span class="errormessage">*</span></td>
                    <td><asp:TextBox ID="txtName" runat="server" CssClass="textboxuppercase" MaxLength="60" Width="250" TabIndex="8"></asp:TextBox><br /><asp:RequiredFieldValidator ID="rfvName" runat="server" CssClass="errormessage" ControlToValidate="txtName" ValidationGroup="Save" Display="Dynamic"></asp:RequiredFieldValidator></td>
                    <td></td>
                    <td>IEC:</td>
                    <td><asp:TextBox ID="txtIec" runat="server" CssClass="textboxuppercase" MaxLength="15" Width="250" TabIndex="17"></asp:TextBox></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>City:</td>
                    <td><asp:TextBox ID="txtCity" runat="server" CssClass="textboxuppercase" MaxLength="50" Width="250" TabIndex="10"></asp:TextBox></td>
                    <td></td>
                    <td>Is Active?:</td>
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="txtPerson1" runat="server" CssClass="textboxuppercase" MaxLength="50" Width="250" TabIndex="20"></asp:TextBox><br /><asp:RequiredFieldValidator ID="rfvPerson1" runat="server" CssClass="errormessage" ControlToValidate="txtPerson1" ValidationGroup="Save" Display="Dynamic"></asp:RequiredFieldValidator></td>
                    <td></td>
                    <td>Contact Person2:</td>
                    <td><asp:TextBox ID="txtPerson2" runat="server" CssClass="textboxuppercase" MaxLength="50" Width="250" TabIndex="24"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>Contact Designation1:<span class="errormessage">*</span></td>
                    <td><asp:TextBox ID="txtDesig1" runat="server" CssClass="textboxuppercase" MaxLength="50" Width="250" TabIndex="21"></asp:TextBox><br /><asp:RequiredFieldValidator ID="rfvDesig1" runat="server" CssClass="errormessage" ControlToValidate="txtDesig1" ValidationGroup="Save" Display="Dynamic"></asp:RequiredFieldValidator></td>
                    <td></td>
                    <td>Contact Designation2:</td>
                    <td><asp:TextBox ID="txtDesig2" runat="server" CssClass="textboxuppercase" MaxLength="50" Width="250" TabIndex="25"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>Contact Mobile1:<span class="errormessage">*</span></td>
                    <td><asp:TextBox ID="txtContactMob1" runat="server" CssClass="textboxuppercase" MaxLength="15" Width="250" TabIndex="22"></asp:TextBox><br /><asp:RequiredFieldValidator ID="rfvContactMob1" runat="server" CssClass="errormessage" ControlToValidate="txtContactMob1" ValidationGroup="Save" Display="Dynamic"></asp:RequiredFieldValidator><asp:RegularExpressionValidator ID="revContactMob1" runat="server" ControlToValidate="txtContactMob1" CssClass="errormessage" ValidationGroup="Save" Display="Dynamic"></asp:RegularExpressionValidator></td>
                    <td></td>
                    <td>Contact Mobile2:</td>
                    <td><asp:TextBox ID="txtContactMob2" runat="server" CssClass="textboxuppercase" MaxLength="15" Width="250" TabIndex="26"></asp:TextBox><br /><asp:RegularExpressionValidator ID="revContactMob2" runat="server" ControlToValidate="txtContactMob2" CssClass="errormessage" ValidationGroup="Save" Display="Dynamic"></asp:RegularExpressionValidator></td>
                </tr>
                <tr>
                    <td>Contact EmailId1:</td>
                    <td><asp:TextBox ID="txtEmail1" runat="server" CssClass="textboxuppercase" MaxLength="50" Width="250" TabIndex="23"></asp:TextBox><br /><asp:RegularExpressionValidator ID="revEmail1" runat="server" ControlToValidate="txtEmail1" CssClass="errormessage" ValidationGroup="Save" Display="Dynamic"></asp:RegularExpressionValidator></td>
                    <td></td>
                    <td>Contact EmailId2:</td>
                    <td><asp:TextBox ID="txtEmail2" runat="server" CssClass="textboxuppercase" MaxLength="50" Width="250" TabIndex="27"></asp:TextBox><br /><asp:RegularExpressionValidator ID="revEmail2" runat="server" ControlToValidate="txtEmail2" CssClass="errormessage" ValidationGroup="Save" Display="Dynamic"></asp:RegularExpressionValidator></td>
                </tr>
                <tr>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ManageCreditNote.aspx.cs" Inherits="EMS.WebApp.Transaction.ManageCreditNote" %>
    ...
    <div>
        ...
        <center>
            <fieldset style="width: 85%;">
                <legend>Add / Edit Credit Note</legend>
                <asp:UpdatePanel ID="upCreditNote" runat="server" UpdateMode="Always">
                    <ContentTemplate>
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td>
                                    <asp:Button ID="btnSave" runat="server" Text="Save" ValidationGroup="VGCrnSave" />
                                    &nbsp;&nbsp;

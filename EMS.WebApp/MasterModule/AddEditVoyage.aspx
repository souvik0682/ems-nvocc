    ...
    <center>
        <fieldset style="width:800px; ">
            ...
            <tr>
              ...
              <tr>
                    ...
                    <td><asp:TextBox ID="txtExcRate" runat="server" CssClass="textboxuppercase" MaxLength="60" Width="250"  onkeyup="IsDecimal(this)" onblur="CheckExchRate()"></asp:TextBox><br />
        ...
        <tr>
         ...
         <tr>
                    ...
                    <td> 
                      <asp:TextBox ID="txtTime" runat="server" CssClass="textboxuppercase" MaxLength="5" Width="250"></asp:TextBox><br />
                   </td>
                </tr>
        <tr>
        ...
        <tr>
                    ...
                    <td><asp:TextBox ID="txtCargoDesc" TextMode="MultiLine" Text="GENARAL" runat="server" CssClass="" MaxLength="14" Width="250"></asp:TextBox><br />
                   </td>
                </tr>

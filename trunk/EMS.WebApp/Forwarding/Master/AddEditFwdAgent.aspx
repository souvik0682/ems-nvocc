<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddEditFwdAgent.aspx.cs"
    MasterPageFile="~/Site.Master" Inherits="EMS.WebApp.Forwarding.Master.AddEditFwdAgent" %>
        ...
        <center>
            <fieldset style="width: 400px;">
                ...
                <table border="0" cellpadding="2" cellspacing="3">
                    ...
                    <tr>
                        <td class="style1">
                            Principal<span class="errormessage1">*</span> :
                        </td>
                        <td class="style2">

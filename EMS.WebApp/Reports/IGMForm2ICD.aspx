<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="IGMForm2ICD.aspx.cs"
    Inherits="EMS.WebApp.Reports.IGMForm2ICD" Title=":: Liner :: IGM Form II ICD" %>
                ...
                <tr>
                  <td style="text-align:left; width:3%">Location:<%--<span class="errormessage1">*</span>--%></td>
                    ...
                    <td style="width:20%">
                      ...
                      <td style="width:5%">FPoD:<span class="errormessage1">*</span></td>
                    <td >

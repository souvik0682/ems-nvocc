<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageService.aspx.cs" MasterPageFile="~/Site.Master" Inherits="EMS.WebApp.MasterModule.ManageService" %>
        ...
        <div style="width: 880px; ">
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <cc1:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender3" runat="server" TargetControlID="txtService"
            ...
            <fieldset id="fsList" runat="server" style="width: 100%; min-height: 100px;">
                ...
                <div style="float: right; padding-bottom: 5px;">
                    ...
                    &nbsp;&nbsp;
                    <asp:Button ID="btnAdd" runat="server" Text="Add Services" Width="150px"
                ...
                <div>
                    <asp:UpdatePanel ID="upLoc" runat="server" UpdateMode="Conditional">
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="gvwService" runat="server" AutoGenerateColumns="false" AllowPaging="true"
                                BorderStyle="None" BorderWidth="0" OnPageIndexChanging="gvwService_PageIndexChanging"
                                OnRowDataBound="gvwService_RowDataBound" OnRowCommand="gvwService_RowCommand"
                                Width="100%">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lnkHService" runat="server" CommandName="Sort" CommandArgument="ServiceName"

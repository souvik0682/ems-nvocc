<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fwdBLPrint.aspx.cs" MasterPageFile="~/Site.Master"
    Inherits="EMS.WebApp.Forwarding.Report.fwdBLPrint" %>
                ...
                <tr id="main">
                    ...
                    <td align="left" style="width: 35%">
                        <asp:DropDownList ID="ddlLocation" runat="server" AutoPostBack="true" 
                            OnSelectedIndexChanged="ddlLocation_SelectedIndexChanged" Width="106px" DataSourceID="OpsDs" DataTextField="LocName" DataValueField="pk_LocID">
                        ...
                        <asp:SqlDataSource ID="OpsDs" runat="server" ConnectionString="<%$ ConnectionStrings:DbConnectionString %>"
                            ...
                            UNION
                            SELECT pk_LocID, LocName FROM fwd.mstFLocation">
                        </asp:SqlDataSource>
                    ...
                    <td>
                        Principal:<span class="errormessage" style="width: 10%">*</span>
                    </td>
                    <td align="left" style="width: 35%">
                        <asp:DropDownList ID="ddlLine" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlLine_SelectedIndexChanged"
                            Width="172px" DataSourceID="LineDs" DataTextField="LineName" DataValueField="pk_FLineID">
                        </asp:DropDownList>
                        <asp:SqlDataSource ID="LineDs" runat="server" ConnectionString="<%$ ConnectionStrings:DbConnectionString %>"
                                ...
                                UNION
                                SELECT pk_FLineID, Prefix LineName FROM fwd.mstFLine">
                        </asp:SqlDataSource>

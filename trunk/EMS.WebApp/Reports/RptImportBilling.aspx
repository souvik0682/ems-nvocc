             ...
             <table border="0" cellpadding="2" cellspacing="3" width="100%">
                    <tr>
                        ...
                        <td style="width: 10%;">
                            ...
                            <asp:TextBox ID="txtBlNo" runat="server" Width="150" AutoPostBack="True" 
                        ...
                        <td style="text-align:left; width:12%" >Date Till:</td>
                        <td style="text-align:left; width:10%">
                        <asp:TextBox ID="txtdtBill" runat="server" CssClass="textboxuppercase" Width="100"></asp:TextBox>
                        <cc2:CalendarExtender ID="dtBill_" Format="dd/MM/yyyy" TargetControlID="txtdtBill" runat="server" />
                        </td>

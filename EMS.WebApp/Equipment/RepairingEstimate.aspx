<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RepairingEstimate.aspx.cs" Inherits="EMS.WebApp.Equipment.RepairingEstimate" %>
    ...
    <div style="width:850px;">        
            ...
            <table>
                <tr>
                    <td>
                        ...
                        <cc1:TextBoxWatermarkExtender ID="txtWMEAbbr" runat="server" TargetControlID="txtContainerNo" WatermarkText="Type Container No" WatermarkCssClass="watermark"></cc1:TextBoxWatermarkExtender>
                        
                    </td>
                    <td>
                        <asp:TextBox ID="txtLocation" runat="server" CssClass="watermark" ForeColor="#747862" ></asp:TextBox>
                        <cc1:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender1" runat="server" TargetControlID="txtLocation" WatermarkText="Type Location" WatermarkCssClass="watermark"></cc1:TextBoxWatermarkExtender>
        ...
        <fieldset id="fsList" runat="server" style="width:100%;min-height:100px;">
            ...
            <div style="float:right;padding-bottom:5px;margin-top: -10px">
                ...
                <asp:Button ID="btnAdd" runat="server" Text="Add New Container" Width="130px" OnClick="btnAdd_Click" />
            </div>
          <br />            
            <div>

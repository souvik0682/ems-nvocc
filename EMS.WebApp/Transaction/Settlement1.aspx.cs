...
{
    public partial class Settlement1 : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/Transaction/ManageSettlement.aspx");
        }
        ...
        protected void gvwContainerTran_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                DeleteSettlement(Convert.ToInt32(e.CommandArgument));
            }
        ...
        protected void gvwContainerTran_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Cells[0].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "LocName"));
                e.Row.Cells[1].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Line"));
                e.Row.Cells[2].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "SettlementNo"));
                e.Row.Cells[3].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "BLNo"));
                e.Row.Cells[4].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "SettlementDate")).Split(' ')[0];
                ...
                btnEdit.CommandArgument = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "pk_SettlementID"));
                if (_canDelete == true)
                {
                    //ImageButton btnRemove = (ImageButton)e.Row.FindControl("btnRemove");
        ...
        private void RedirecToAddEditPage(int id)
        {
            ...
            Response.Redirect("~/Transaction/ManageSettlement.aspx?id=" + encryptedId);
        }
        ...
        private void BuildSearchCriteria(SearchCriteria criteria)
        {
            ...
            {
                sortExpression = "SettlementNo";
                sortDirection = "DESC";
            }

            criteria.SortExpression = sortExpression;
            criteria.SortDirection = sortDirection;
            criteria.BookingNo = txtSettlementNo.Text.Trim();
            criteria.BLNo = txtEdgeBLNo.Text.Trim();
            criteria.LocName = txtLocation.Text.Trim();

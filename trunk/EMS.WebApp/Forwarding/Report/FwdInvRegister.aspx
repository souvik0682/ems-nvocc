<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FwdInvRegister.aspx.cs" Inherits="EMS.WebApp.Forwarding.Report.FwdInvRegister" Title=":: Liner :: Forwarding Invoice Register" %>
        ...
        <fieldset style="width:964px;height:65px;">
            <table>
                <tr>
                    ...
                    <td class="label" style="padding-right:5px;vertical-align:top;">
                        Bill Currency:<span class="errormessage">*</span>
                    </td>
                    <td style="padding-right:20px;vertical-align:top;">

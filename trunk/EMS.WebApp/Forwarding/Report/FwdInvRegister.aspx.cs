...
{
    public partial class FwdInvRegister : System.Web.UI.Page
    {
        ...
        private void PopulateBillType()
        {
            ...
            ddlType.DataValueField = "pk_CurrencyID";
            ddlType.DataTextField = "CurrencyCode";
            ddlType.DataSource = cur;
            ddlType.DataBind();
        ...
        private void GenerateNavigationLink()
        {
            ...
            string ss = string.Format("ReportPrint2('{0}')",
              "reportName=" + EMS.Utilities.GeneralFunctions.EncryptQueryString("MIDForwarding") +

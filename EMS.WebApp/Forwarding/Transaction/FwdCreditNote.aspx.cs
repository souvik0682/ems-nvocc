...
{
    public partial class FwdCreditNote : System.Web.UI.Page
    {
        ...
        {
            ICreditNote creditNote = new CreditNoteBLL().GetfwdCrnHeaderInformation(InvoiceId);
            ...
            if (creditNote != null)
            {
                ...
                ViewState["jobId"] = creditNote.BLID;
            }
        }

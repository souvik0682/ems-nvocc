                    ...
                    <td style="width: 50%; vertical-align: top;">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="errormessage"
                                        ControlToValidate="ddlVessel" InitialValue="0" Display="Dynamic" Text="This field is Required"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtIGMNo" runat="server" CssClass="textboxuppercase" MaxLength="10"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtTotLine" runat="server" CssClass="textboxuppercase" MaxLength="5"
                                        Width="250"></asp:TextBox><br />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <%--<uc3:DatePicker ID="dtETA" runat="server" />--%>
                                    <asp:TextBox ID="txtdtETA" runat="server" CssClass="textboxuppercase" Width="250"></asp:TextBox>
                                    <cc2:CalendarExtender ID="dtETA_" TargetControlID="txtdtETA" Format="dd/MM/yyyy"
                                        runat="server" />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtTime" runat="server" CssClass="textboxuppercase" MaxLength="5"
                                        Width="150"></asp:TextBox>
                                    <cc2:TextBoxWatermarkExtender ID="txtWMEAbbr" runat="server" TargetControlID="txtTime"
                                        WatermarkText="hh:mm" WatermarkCssClass="watermark1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtPCCNo" runat="server" CssClass="textboxuppercase" MaxLength="10"
                                        Width="250"></asp:TextBox><br />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtVIA" runat="server" CssClass="textboxuppercase" MaxLength="10"
                                        Width="250"></asp:TextBox><br />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtCargoDesc" TextMode="MultiLine" Text="GENERAL" runat="server"
                                        CssClass="" MaxLength="14" Width="250"></asp:TextBox><br />
                                </td>
                            </tr>
                            <tr runat="server" id="trLandDate">
                                ...
                                <td>
                                    <asp:TextBox ID="txtLGNo" runat="server" CssClass="textboxuppercase" MaxLength="40"
                                        Width="250"></asp:TextBox><br />
                                </td>
                            </tr>
                        </table>
                    ...
                    <td style="width: 50%; vertical-align: top;">
                        <table width="100%">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtExcRate" runat="server" CssClass="textboxuppercase" Style="text-align: right"
                                        MaxLength="60" Width="150" onkeyup="IsDecimal(this)" onblur="CheckExchRate()"></asp:TextBox><br />
                                    <asp:RequiredFieldValidator ID="rfvName" runat="server" CssClass="errormessage" ControlToValidate="txtExcRate"
                                        Display="Dynamic" Text="This field is Required" ValidationGroup="Save"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 140px;">
                                ...
                                <td>
                                    <asp:TextBox ID="txtVoyageNo" runat="server" CssClass="textboxuppercase" MaxLength="10"
                                        Width="250"></asp:TextBox><br />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" CssClass="errormessage"
                                        ControlToValidate="txtVoyageNo" Display="Dynamic" Text="This field is Required"
                                        ValidationGroup="Save"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <cc2:CalendarExtender ID="dtIGM_" TargetControlID="txtDtIGM" Format="dd/MM/yyyy"
                                        runat="server" />
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 140px;">
                                    Last Port Called:<span class="errormessage1">*</span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtLightHouse" runat="server" Style="text-align: right" CssClass="textboxuppercase"
                                        MaxLength="10" Width="150" onkeyup="IsNumeric(this)"></asp:TextBox><br />
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <%--<uc3:DatePicker ID="dtPCC" runat="server" />--%>
                                    <asp:TextBox ID="txtdtPCC" runat="server" CssClass="textboxuppercase" Width="250"></asp:TextBox>
                                    <cc2:CalendarExtender ID="dtPCC_" TargetControlID="txtdtPCC" Format="dd/MM/yyyy"
                                        runat="server" />
                                    <br />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtVCN" runat="server" CssClass="textboxuppercase" MaxLength="14"
                                        Width="250"></asp:TextBox><br />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtMotherDaughter" CssClass="textboxuppercase" TextMode="MultiLine"
                                        runat="server" MaxLength="14" Width="250"></asp:TextBox><br />
                                </td>
                            </tr>
                            <tr id="AdLand" style="display: none">
                                ...
                                <td>
                                    ...
                                    <cc2:CalendarExtender ID="dtAddLand_" TargetControlID="txtdtAddLand" Format="dd/MM/yyyy"
                                        runat="server" />
                                </td>
                            </tr>
                            <tr id="AddGur" style="display: none">
                                ...
                                <td>
                                    <asp:TextBox ID="txtAltLGNo" runat="server" CssClass="textboxuppercase" MaxLength="10"
                                        Width="250"></asp:TextBox><br />
                                </td>
                            </tr>
                        </table>

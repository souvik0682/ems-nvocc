...
namespace EMS.WebApp.View
{
    public partial class ManageCustomer : System.Web.UI.Page
    {
        ...
        private void RedirecToAddEditPage(int id)
        {
            ...
            Response.Redirect("~/View/AddEditCustomer.aspx?id=" + encryptedId);
        }
        ...
        private void BuildSearchCriteria(SearchCriteria criteria)
        {
            ...
            criteria.CustomerName = (txtCustName.Text == ResourceManager.GetStringWithoutName("ERR00035")) ? string.Empty : txtCustName.Text.Trim();
            criteria.GroupName = (txtGrComp.Text == ResourceManager.GetStringWithoutName("ERR00034")) ? string.Empty : txtGrComp.Text.Trim();
            criteria.LocAbbr = (txtLoc.Text == ResourceManager.GetStringWithoutName("ERR00031")) ? string.Empty : txtLoc.Text.Trim();
            criteria.ExecutiveName = (txtLoc.Text == ResourceManager.GetStringWithoutName("ERR00069")) ? string.Empty : txtExec.Text.Trim();

    ...
    public partial class AddEditCustomer : System.Web.UI.Page
    {
        ...
        private void SetAttributes()
        {
            if (!IsPostBack)
            {
                ...
                rfvGroup.ErrorMessage = ResourceManager.GetStringWithoutName("ERR00036");
                rfvLoc.ErrorMessage = ResourceManager.GetStringWithoutName("ERR00037");
                rfvArea.ErrorMessage = ResourceManager.GetStringWithoutName("ERR00038");
                rfvCustType.ErrorMessage = ResourceManager.GetStringWithoutName("ERR00039");
                rfvCorpLoc.ErrorMessage = ResourceManager.GetStringWithoutName("ERR00040");
                rfvName.ErrorMessage = ResourceManager.GetStringWithoutName("ERR00041");
                rfvAddr.ErrorMessage = ResourceManager.GetStringWithoutName("ERR00042");
                rfvPhone1.ErrorMessage = ResourceManager.GetStringWithoutName("ERR00043");
                rfvPerson1.ErrorMessage = ResourceManager.GetStringWithoutName("ERR00044");
                rfvDesig1.ErrorMessage = ResourceManager.GetStringWithoutName("ERR00045");
                rfvContactMob1.ErrorMessage = ResourceManager.GetStringWithoutName("ERR00046");
                revEmail1.ErrorMessage = ResourceManager.GetStringWithoutName("ERR00026");
                revEmail2.ErrorMessage = ResourceManager.GetStringWithoutName("ERR00026");
                rfvExecutive.ErrorMessage = ResourceManager.GetStringWithoutName("ERR00071");
                revPhone1.ErrorMessage = ResourceManager.GetStringWithoutName("ERR00027");
                revPhone2.ErrorMessage = ResourceManager.GetStringWithoutName("ERR00027");
                revContactMob1.ErrorMessage = ResourceManager.GetStringWithoutName("ERR00028");
                revContactMob2.ErrorMessage = ResourceManager.GetStringWithoutName("ERR00028");
        ...
        private void CheckUserAccess()
        {
            ...
            if (_custId == 0)
                Response.Redirect("~/View/ManageCustomer.aspx");
        }

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManagePort.aspx.cs" Inherits="EMS.WebApp.MasterModule.ManagePort" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="container" runat="server">
 <div id="dvAsync" style="padding: 5px; display: none;">
    ...
    <div id="headercaption">MANAGE PORT</div>
    <center>
    <div style="width:850px;">        
        <fieldset style="width:100%;">
            <legend>Search Port</legend>
            <table>
                <tr>
                    <td>
                        <asp:TextBox ID="txtPortCode" runat="server" CssClass="watermark" ForeColor="#747862" ></asp:TextBox>
                        <cc1:TextBoxWatermarkExtender ID="txtWMEAbbr" runat="server" TargetControlID="txtPortCode" WatermarkText="Type Port Code" WatermarkCssClass="watermark"></cc1:TextBoxWatermarkExtender>
                    </td>
                    <td>
        ...
        <fieldset id="fsList" runat="server" style="width:100%;min-height:100px;">
            ...
            <div style="float:right;padding-bottom:5px;margin-top: -10px">
                ...
                <asp:Button ID="btnAdd" runat="server" Text="Add New Port" Width="130px" OnClick="btnAdd_Click" />
            </div>
          <br />            
            <div>
                ...
                <emptydatatemplate>No Port(s) Found</emptydatatemplate>
                <columns>
                                ...
                                <asp:TemplateField HeaderText="Port Code" SortExpression="PortCode">
                                    <HeaderStyle CssClass="gridviewheader" />
